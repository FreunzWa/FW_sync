...
### Combination incontinence syndromes

# Mixed incontinence
- mixed incontinence (stress and urgency may both be present). two subtypes: urgency predominant and stress predominant.

# Detrusor hyperreflexia with impaired contractility
- basics
    + @hypersensitive detrusor, with -=contractile capacity due to intrinsic weakness (eg @nervous issue/ wall weakness/ scarred)
    + afferent functional, efferent arc dysfunctional
